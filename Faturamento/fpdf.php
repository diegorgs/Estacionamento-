...
class FPDF
{
	...
	function AddPage($orientation = '', $size = '', $rotation = 0, $tipo = 0)
	{
		// Start a new page
		$this->CurTipo = $tipo;
		if ($this->state == 3)
		...
		switch ($tipo) {
			case 1:
				if ($this->page != 1) {
					...
					$this->Cell(60, 8, "Entrada", 1, 0, 'C',);
					$this->Cell(60, 8, "Saida", 1, 0, 'C',);
					$this->Cell(30, 8, "Placa", 1, 0, 'C',);
					$this->Cell(30, 8, "Valor Pago", 1, 1, 'C',);
				}
	...
	function Cell($w, $h = 0, $txt = '', $border = 0, $ln = 0, $align = '', $fill = false, $link = '')
	{
		...
		if ($this->y + $h > $this->PageBreakTrigger && !$this->InHeader && !$this->InFooter && $this->AcceptPageBreak()) {
			...
			$this->AddPage($this->CurOrientation, $this->CurPageSize, $this->CurRotation, $this->CurTipo);
			$this->x = $x;
			if ($ws > 0) {
				$this->ws = $ws;
